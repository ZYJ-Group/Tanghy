...
## A2. 系统/几何/坐标系语境(Sec. 2.1; Sec. 2.2.3; Fig. 1; Fig. 3; Fig. 4)
...
# C. 作者整体思路(Sec. 2; Fig. 2)
## C1. 端到端管线(Sec. 2.2.1; Sec. 2.2.4–2.2.5; Fig. 2)
...
# E. 实验与结果(Sec. 3.1–3.3; Table 1–5; Fig. 5–15)
## E1. 实验组织总览(Sec. 3)
...
## F1. 作者声称的核心贡献点(Abstract; Sec. 1; Sec. 2)
